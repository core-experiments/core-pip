"""Errors raised by pip's network services."""

from __future__ import annotations

from typing import Literal

from pip.core.errors import DiagnosticPipError, PipError
...
class IncompleteDownloadError(PipError):
