...
from pip.install.build_env.base import BuildIsolationMode
from pip.install.build_env.noop import NoOpBuildEnvironment
...
if TYPE_CHECKING:
    from pip.install.build_env.base import BuildEnvironmentInstaller
