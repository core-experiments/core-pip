...
from pip.core.appdirs import site_config_dirs, user_config_dir
...
def get_configuration_files() -> dict[Kind, list[str]]:
    global_config_files = [
        os.path.join(path, CONFIG_BASENAME) for path in site_config_dirs("pip")
    ]
    ...
    new_config_file = os.path.join(user_config_dir("pip"), CONFIG_BASENAME)
    return {
