...
from cpip._vendor.charset_normalizer import md as md_module
from cpip._vendor.charset_normalizer import from_fp
from cpip._vendor.charset_normalizer.models import CliDetectionResult
from cpip._vendor.charset_normalizer.version import __version__
