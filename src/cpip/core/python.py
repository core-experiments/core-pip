...
CURRENT_PYTHON_VERSION = f"{CURRENT_PYTHON_VERSION_INFO.major}.{CURRENT_PYTHON_VERSION_INFO.minor}"
CURRENT_PYTHON_VERSION_DIGITS = CURRENT_PYTHON_VERSION.replace(".", "")
CURRENT_PYTHON_VERSION_FULL = ".".join(str(part) for part in CURRENT_PYTHON_VERSION_INFO[:3])
