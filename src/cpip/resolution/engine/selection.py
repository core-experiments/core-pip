...
if TYPE_CHECKING:
    ...
    from cpip.resolution.engine.context import SelectionContext
...
class SelectionOperations:
    ...
    def emit_backtracking_message(self: SelectionContext) -> None:
    ...
    def choose_requirement(
        ...
        if len(pending.by_name) >= 4:
            ...
            for name, entry_id, requirement, order, is_direct in unresolved:
                ...
                work_cost = self.provider.candidate_work_cost(requirement)
                score = (
                    (candidate_count or 10**9) * work_cost,
    ...
    def find_candidates_internal(
        ...
        requirement: Requirement,
        *,
        source_requirements: dict[str, RequirementInput] | None = None,
        source_requirements_by_url: dict[str, RequirementInput] | None = None,
    ) -> CandidateStream:
