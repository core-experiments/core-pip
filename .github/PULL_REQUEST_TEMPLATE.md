...
- Added a news file fragment (see https://cpip.pypa.io/en/latest/development/contributing/#news-entries)
-->
...
- [ ] I have read and have followed the [CONTRIBUTING.md](https://github.com/pypa/cpip/blob/main/.github/CONTRIBUTING.md) file.
- [ ] I have added a news file fragment (or this PR does not need one).
- [ ] I have read and followed the [AI_POLICY.md](https://github.com/pypa/cpip/blob/main/AI_POLICY.md) file, and if any AI tools were used, I have disclosed it below.
