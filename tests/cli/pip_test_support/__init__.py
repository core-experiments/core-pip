...
from pip.cli.main import main as pip_entry_point
from pip.core.direct_url import DIRECT_URL_METADATA_NAME, DirectUrl
from pip.core.release_control import ReleaseControl
from pip.install.build_env.installer import BuildConfiguration
from pip.network.http import NetworkSession
from pip.platform.locations.base import get_major_minor_version
from scripttest import FoundDir, FoundFile, ProcResult, TestFileEnvironment

from pip_test_support.filesystem import create_file
...
def make_test_build_options(
    ...
    return BuildConfiguration(
        ...
        proxy=session.pip_proxy,
        no_proxy_env=session.pip_no_proxy_env,
